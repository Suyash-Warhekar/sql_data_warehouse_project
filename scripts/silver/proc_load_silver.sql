/*NEW DATA INSERT SILVER
STORED PROCEDURE 
RUN USING : EXEC silver.load_silver
*/
		...
		BEGIN TRY
			...
			SELECT 
				...
				CASE WHEN UPPER(TRIM(cst_material_status)) = 'S' THEN 'Single'
					...
					ELSE 'n/a'
				END cst_material_status,--Normalize marital status 
										--values to readable format
